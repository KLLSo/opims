...
.a1 {
  ...
  <body>
	<div class="top1">
		<marquee scrollAmount=2 width=300>欢迎各大企业发布兼职！！！</marquee>
	</div>
	<div class="top2">
		<div class="logo">
		...
		<div class="title" >
			<h3>兼职中介后台管理系统-企业中心</h3>
		</div>
		<div class="fr top-link">
			<a href="admin_list.html" target="mainCont" title="DeathGhost"><i
				class="adminIcon"></i><span>企业：DeathGhost</span></a> 
		</div>
	</div>
           ...
           <div class="div2">
			...
			<ul>
				<li><a class="a" href="javascript:void(0);"
					onClick="openurl('jobDemandQuery.html');">查看兼职需求</a></li>
				<li><a class="a" href="javascript:void(0);"
					onClick="openurl('jobDemandAdd.html');">添加兼职需求</a></li>
			  </ul>
			</div>
			<div class="div2">
				<div class="yhgl"></div>
			...
			<div class="div3">
				<ul>
					<li><a class="a" href="javascript:void(0);"
						onClick="openurl('info_firm.html');">我的信息</a></li>
					<li><a class="a" href="javascript:void(0);"
						onClick="openurl('infoAlter_firm.html');">修改信息</a></li>
				</ul>
			</div>
