           ...
           <div class="div2">
			...
			<div class="div3">
				<li><a class="a" href="javascript:void(0);"
					onClick="openurl('jobQuery.html');">查看所有兼职</a></li>
				<li><a class="a" href="javascript:void(0);"
					onClick="openurl('firmjobQuery.html');">企业兼职列表</a></li>
			...
			<div class="div3">
				<ul>
					<li><a class="a" href="javascript:void(0);"
						onClick="openurl('personQuery.html');">个人管理</a></li>
					<li><a class="a" href="javascript:void(0);"
						onClick="openurl('firmQuery.html');">企业管理</a></li>
				</ul>
			</div>
